...
def remove_watermark(image_path, output_path, model_path="yolov7_tiktok_watermark.onnx", conf_threshold=0.25):
    ...
    detections = postprocess_output(output, image.shape, conf_threshold=conf_threshold)
